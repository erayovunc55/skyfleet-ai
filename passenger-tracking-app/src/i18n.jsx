...
const phrases = {
  ...
  "Siyah": { en: "Black", ar: "أسود", es: "Negro" },
  "Beyaz": { en: "White", ar: "أبيض", es: "Blanco" },
  "Gri": { en: "Gray", ar: "رمادي", es: "Gris" },
  "Gümüş": { en: "Silver", ar: "فضي", es: "Plateado" },
  "Mavi": { en: "Blue", ar: "أزرق", es: "Azul" },
  "Kırmızı": { en: "Red", ar: "أحمر", es: "Rojo" },
  "Yeşil": { en: "Green", ar: "أخضر", es: "Verde" },
  "Lacivert": { en: "Navy Blue", ar: "كحلي", es: "Azul marino" },
  "Bej": { en: "Beige", ar: "بيج", es: "Beige" },
  "Kahverengi": { en: "Brown", ar: "بني", es: "Marrón" },
  "Sarı": { en: "Yellow", ar: "أصفر", es: "Amarillo" },
  "Turuncu": { en: "Orange", ar: "برتقالي", es: "Naranja" },
